...
import { Leaf, Heart, Mail, Twitter, Instagram, Facebook } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              ...
              gamification, and conservation support. Every purchase helps protect wildlife.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/animals" className="text-gray-300 hover:text-white transition-colors">
                  Endangered Animals
                </Link>
              </li>
              <li>
